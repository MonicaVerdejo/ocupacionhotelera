        ...
        <div class="page-wrapper chiller-theme toggled">
            ...
            <main class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- TABLAS -->
                    <form class="form-inline mt-4 mb-2 mr-0 txt-center container" method="POST" name="formFechas"
                        id="formFechas">
                    ...
                    <form method="POST" class="container mr-0">
                        <div class="row col-5  mt-4">
                            <div class="input-group mb-3">
                                <input name="consulta" type="text" class="form-control" placeholder="Dato a consultar"
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">ESTADISTICA DE LA OCUPACIÓN HOTELERA</h3>
                                        </div>
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                        ...
                                        if (!empty($_POST['consulta'])) {
                                            ...
                                            $sentencia = $db->connect()->prepare("SELECT hotel, habitaciones_ocupadas,dias_vacaciones,num_habitaciones,costo_hotel, personas_nacionales, personas_extranjeras, fecha_inicio,fecha_fin FROM registro WHERE Hotel LIKE '%" . $q . "%' OR habitaciones_ocupadas LIKE '%" . $q . "%' OR dias_vacaciones LIKE '%" . $q . "%' OR num_habitaciones LIKE '%" . $q . "%' OR costo_hotel LIKE '%" . $q . "%' ");
                                            $sentencia->execute();
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo round((($row[1] / $row[2] / $row[3]) * 100), 2); ?>
                                                        </td>
                                        ...
                                        $sentencia = $db->connect()->prepare("SELECT hotel, habitaciones_ocupadas,dias_vacaciones,num_habitaciones,costo_hotel, personas_nacionales, personas_extranjeras, fecha_inicio,fecha_fin FROM registro WHERE fecha_inicio BETWEEN '{$fecha_inicio}' AND '{$fecha_final}'");
                                        $sentencia->execute();
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row[7]; ?></td>
                                                        <td><?php echo $row[8]; ?></td>
                                                        <td><?php echo round((($row[1] / $row[2] / $row[3]) * 100), 3); ?>
                                                        </td>
                                                        <td>$ <?php echo $row[1] * $row[4]; ?></td>
                                                    </tr>
                                                    <?php
